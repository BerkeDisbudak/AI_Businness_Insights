    ...
    >
        ...
        options={{
          ...
          tabBarIcon: ({ color, size }) => (
            <View style={styles.iconContainer}>
              <Home color={color} size={size + 2} /> {/* İkon boyutu biraz artırıldı */}
            </View>
          ),
        }}
      />
      ...
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, size }) => (
            <View style={styles.iconContainer}>
              <FileText color={color} size={size + 2} /> {/* İkon boyutu biraz artırıldı */}
            </View>
          ),
        }}
      />
      ...
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, size }) => (
            <View style={styles.iconContainer}>
              <TrendingUp color={color} size={size + 2} /> {/* İkon boyutu biraz artırıldı */}
            </View>
          ),
        }}
      />
      ...
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, size }) => (
            <View style={styles.iconContainer}>
              <Lock color={color} size={size + 2} /> {/* İkon boyutu biraz artırıldı */}
            </View>
          ),
        }}
      />
      ...
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, size }) => (
            <View style={styles.iconContainer}>
              <Settings color={color} size={size + 2} /> {/* İkon boyutu biraz artırıldı */}
            </View>
          ),
        }}
      />
...
const styles = StyleSheet.create({
  iconContainer: {
    ...
    width: 36, // İkon kapsayıcısının genişliği artırıldı
    height: 36, // İkon kapsayıcısının yüksekliği artırıldı
  },
});